...
public class AccountInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = AccountInfo.this.getWindow();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.setStatusBarColor(AccountInfo.this.getResources().getColor(R.color.light_blue));
        }
    ...
    public class GetAccountDetails extends AsyncTask<String,String,String>
    {
        ...
        protected void onPreExecute() {
            loadingDialog = createProgressDialog(AccountInfo.this);
            loadingDialog.show();
        }
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                SharedPreferences Database_Details = AccountInfo.this.getSharedPreferences("database_details", MODE_PRIVATE);
                String db=Database_Details.getString("database_name","");
                String ip=Database_Details.getString("database_ip_address","");
                String un=Database_Details.getString("database_username","");
                String password=Database_Details.getString("database_password","");
                Connection con = connectionClass.CONN(ip,db,un,password,"SQLEXPRESS");
                if (con == null) {
                    z = "Error in connection with SQL server";
                } else {

                    String querycmd = "Select first_name,last_name,fah.account_type,fc.status,ammount,openingdate,account_number from CIS_FINREST_CUSTOMER fc inner join CIS_FINREST_ACCOUNT fa on fc.customer_id=fa.customer_id inner join CIS_FINREST_ACCOUNTHEAD fah on fah.account_head=fa.account_type where fc.customer_id='"+ customerid +"'";
    ...
    private BroadcastReceiver mConnReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (networkInfo != null && networkInfo.isConnected()) {
                ...
                final Dialog dialog = new Dialog(AccountInfo.this);
